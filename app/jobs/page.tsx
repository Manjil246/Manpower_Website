...
export default function JobsPage() {
  ...
  useEffect(() => {
    const fetchJobs = async () => {
      ...
      if (data && !error) {
        ...
        const uniqueLocations = ["All", ...new Set(data.map((job) => job.country))]
  ...
  const filteredJobs = jobs.filter((job) => {
    ...
    const matchesLocation = selectedLocation === "All" || job.country === selectedLocation
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Explore our latest job opportunities across 15+ countries with competitive salaries and excellent
              benefits.
            </p>
          </div>
            ...
            {filteredJobs.map((job) => (
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  <Image
                    src={job.image_url || "/placeholder.svg?height=250&width=400"}
                    alt={job.title}
                    fill
                  ...
                  <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors duration-300 flex items-center justify-center">
                    <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      <h3 className="text-white text-xl font-bold text-center px-4">{job.title}</h3>
                    </div>
                  </div>
